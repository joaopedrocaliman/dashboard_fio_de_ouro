let nomeoperador = prompt("Qual seu nome?");
document.getElementById("operador").innerHTML = "Operador: " + nomeoperador;

document.getElementById("main").style.backgroundColor = "lightgray";

let temp = Number(prompt("Qual a temperatura atual da máquina em ºC?"));

document.querySelector(".temp-texto").innerHTML = temp + "ºC";
// ================= MODAL OCORRÊNCIA =================
const modal = document.getElementById("modal-ocorrencia");
const btnFechar = document.getElementById("btn-fechar");
const botoesOcorrencia = document.querySelectorAll(
  ".card-maquina button.ocorrencia",
);
...
botoesPower.forEach((botao) => {
  botao.addEventListener("click", (e) => {
    ...
    const statusTexto =
      maquinaSelecionada.querySelector(".status-texto").textContent;

    powerTexto.textContent =
      statusTexto === "Ligado"
